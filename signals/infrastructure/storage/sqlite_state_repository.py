...
from signals.domain.models import ManagerQuarterSnapshot, ManagerState, Position, TrendRun, TrendStockSignal
    ...
    def get_trend_run(self, report_quarter: str) -> TrendRun | None:
        try:
            ...
            return TrendRun(
                ...
                is_backfill=bool(int(row["is_backfill"])),
                backfill_batch_id=row["backfill_batch_id"],
            )
        except sqlite3.Error as exc:
                ...
                self._conn.executemany(
                    ...
                    [
                        (
                            ...
                            1 if signal.is_backfill else 0,
                            signal.backfill_batch_id,
                        )
