...
from signals.domain.exceptions import InvalidInformationTableError
from signals.domain.models import Position
...
def parse_infotable(xml_text: str) -> list[Position]:
    try:
        root = ET.fromstring(xml_text)
    except ET.ParseError as exc:
        raise InvalidInformationTableError(f"Invalid information table XML: {exc}") from exc
